...
from hesaplama import parse_time_to_minutes, SABAH_TOLERANS_DK
...
class RecordsPage(QWidget):
    ...
    def _export_to_excel_legacy(self):  # WHY: keep original sync export as reference; replaced by threaded version below.
        ...
        try:
            if openpyxl is None:
                raise ImportError("openpyxl yüklü değil. Lütfen '.venv\Scripts\python.exe -m pip install openpyxl' komutunu çalıştırın.")
