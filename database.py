...
from hesaplama import hesapla_hakedis, NORMAL_GUNLUK_SAAT
import migrations
try:
    import bcrypt
except Exception:
...
class Database:
        ...
        with self.get_connection() as conn:
            ...
            tables = {
                ...
                "avans_kesinti": '''CREATE TABLE IF NOT EXISTS avans_kesinti (
                                        id INTEGER PRIMARY KEY AUTOINCREMENT,
                                        tarih TEXT, ad_soyad TEXT, tur TEXT, tutar REAL, aciklama TEXT)''',
    ...
    def get_dashboard_data(self, year, month, tersane_id=None):
        ...
        with self.get_connection() as conn:
            ...
            sql_avans = """SELECT a.ad_soyad, SUM(CASE WHEN a.tur='Avans' THEN a.tutar ELSE -a.tutar END) FROM avans_kesinti a
                                WHERE a.tarih LIKE ?"""
